...
Процедура ПоказатьСообщения(ЗаголовокФормы = НеОпределено) Экспорт
	...
	КартинкаИнформация			= РаботаСДиалогамиЗК.ПолучитьПутьККартинкеДляHTML(БиблиотекаКартинок.СообщениеИнформация, Форма.ЭлементыФормы.HTMLДокумент);
	КартинкаВажнаяИнформация	= РаботаСДиалогамиЗК.ПолучитьПутьККартинкеДляHTML(БиблиотекаКартинок.СообщениеВажнаяИнформация, Форма.ЭлементыФормы.HTMLДокумент);
	КартинкаОшибка				= РаботаСДиалогамиЗК.ПолучитьПутьККартинкеДляHTML(БиблиотекаКартинок.СообщениеОшибка, Форма.ЭлементыФормы.HTMLДокумент);
	КартинкаОткрыть				= РаботаСДиалогамиЗК.ПолучитьПутьККартинкеДляHTML(БиблиотекаКартинок.СообщениеОткрыть, Форма.ЭлементыФормы.HTMLДокумент);
	КартинкаЗакрыть				= РаботаСДиалогамиЗК.ПолучитьПутьККартинкеДляHTML(БиблиотекаКартинок.СообщениеЗакрыть, Форма.ЭлементыФормы.HTMLДокумент);

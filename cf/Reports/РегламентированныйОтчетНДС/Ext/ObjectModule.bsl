...
Форма20040101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151001", '20031120', "БГ-3-03/644",	"ФормаОтчета2004Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20040101, "3.00003");

Форма20050301 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151001", '20050303', "31н",			"ФормаОтчета2005Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20050301, "3.00004");

Форма20060101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151001", '20051228', "163н",			"ФормаОтчета2006Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20060101, "3.00005");

Форма20070101_1 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151001", '20061107', "136н",		"ФормаОтчета2007Кв1", , '20071231');
ОпределитьФорматВДеревеФормИФорматов(Форма20070101_1, "3.00006");

Форма20070101_2 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151001", '20071121', "113н",		"ФормаОтчета2007Кв1", '20080101', '20081231');
ОпределитьФорматВДеревеФормИФорматов(Форма20070101_2, "3.00006");

Форма20070101_3 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151001", '20080911', "94н",			"ФормаОтчета2007Кв1", '20090101');
ОпределитьФорматВДеревеФормИФорматов(Форма20070101_3, "3.00006");

Форма20091001 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151001", '20091015', "104н",			"ФормаОтчета2009Кв4", ,'20100331');
ОпределитьФорматВДеревеФормИФорматов(Форма20091001, "5.01");

Форма20100601 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151001", '20100421', "36н",			"ФормаОтчета2009Кв4", '20100401');
ОпределитьФорматВДеревеФормИФорматов(Форма20091001, "5.01");
...
НоваяФорма.ДатаКонецДействия  = '20100331';
...
НоваяФорма.ДатаНачалоДействия = '20100401'; 

...
Процедура СформироватьКнигуПокупок(ЭлементыФормы) Экспорт
	...
	Иначе
		мСписокОрганизаций = ОбщегоНазначения.ПолучитьСписокОбособленныхПодразделений(Организация);
	КонецЕсли;
	...
	СформироватьДополнительныеЛисты(ЭлементыФормы, УчетнаяПолитикаНУ);
...
Процедура СформироватьОсновнойРаздел(ЭлементыФормы, УчетнаяПолитикаНУ);
...
Процедура СформироватьДополнительныеЛисты(ЭлементыФормы, УчетнаяПолитикаНУ = Неопределено)
...
Функция ОпределитьДатуИНомерСФ(ЗаписьКниги, Секция = Неопределено)
	...
	Если ЗначениеЗаполнено(ЗаписьКниги.СчетФактураДокумент) Тогда
		Если ТипЗнч(ЗаписьКниги.СчетФактураДокумент) = Тип("ДокументСсылка.СчетФактураПолученный") 
			ИЛИ ТипЗнч(ЗаписьКниги.СчетФактураДокумент) = Тип("ДокументСсылка.КорректировочныйСчетФактураПолученный")
...
Функция ПолучитьЗаписиКнигиПокупок(СписокСчетовФактур)
	...
	Запрос.Текст = 
	 ...
	 |		КОГДА НДСЗаписиКнигиПокупокОбороты.СчетФактура ССЫЛКА Документ.КорректировочныйСчетФактураВыданный
	 |			ТОГДА НДСЗаписиКнигиПокупокОбороты.Организация
	 ...
	 |					И (НЕ(НДСЗаписиКнигиПокупокОбороты.СчетФактура ССЫЛКА Документ.ВозвратТоваровОтПокупателя
	 |							И ВЫРАЗИТЬ(НДСЗаписиКнигиПокупокОбороты.СчетФактура КАК Документ.ВозвратТоваровОтПокупателя).ПокупателемВыставляетсяСчетФактураНаВозврат))
	 |				ИЛИ НДСЗаписиКнигиПокупокОбороты.СчетФактура ССЫЛКА Документ.КорректировочныйСчетФактураВыданный
	 |			ТОГДА ВЫБОР

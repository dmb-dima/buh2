...
Функция ПрибылиИУбытки(Счет911, Счет912, ВидРасходов, Флаг, ЕстьПланСчетовНалоговый = Истина) Экспорт
	...
	|	НалоговыйОбороты.Субконто3 КАК Субконто3", "") + "
  	|ИЗ
  	|	РегистрБухгалтерии.Налоговый.Обороты(&ДатаНач, &ДатаКон, , Счет = &Счет911, , Организация В (&Организация) И ВидУчета = &ВидУчета, КорСчет <> &КорСчет, ) КАК НалоговыйОбороты
  	|";
	...
	|	НалоговыйОбороты.Субконто3 КАК Субконто3", "") + "
  	|ИЗ
  	|	РегистрБухгалтерии.Налоговый.Обороты(&ДатаНач, &ДатаКон, , Счет = &Счет912, , Организация В (&Организация) И ВидУчета = &ВидУчета, КорСчет <> &КорСчет, ) КАК НалоговыйОбороты
  	|";
	...
	мБухИтогиРезультат.Свернуть("Субконто2" + ?(Счет911.ВидыСубконто.Количество() = 3, ", Субконто3", ""), "Результат");
	Результат = 0;
...
Форма20040601 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151006", '20040603', "САЭ-3-02/351@",		"ФормаОтчета2004Кв2");
ОпределитьФорматВДеревеФормИФорматов(Форма20040601, "3.00004");

Форма20050101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151006", '20050225', "03-03-01-02/65",	"ФормаОтчета2005Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20050101, "3.00005");

Форма20060101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151006", '20060207', "24н",				"ФормаОтчета2006Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20060101, "3.00006");

Форма20070201 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151006", '20070109', "1н",				"ФормаОтчета2007Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20070201, "3.00007");

Форма20080601 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151006", '20080505', "54н",				"ФормаОтчета2008Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20080601, "5.01");

Форма20091201 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151006", '20091216', "135н",				"ФормаОтчета2009Кв4");
ОпределитьФорматВДеревеФормИФорматов(Форма20091201, "5.02");

Форма20101201 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151006", '20101215', "ММВ-7-3/730@",		"ФормаОтчета2010Кв4");

...
НоваяФорма.ОписаниеОтчета     = "Приложение 6 к Положению о представлении декларации об объёмах производства, оборота и использования этилового спирта, алкогольной и спиртосодержащей продукции (Утверждено Постановлением Правительства РФ от 31.12.2005  № 858)";
...
НоваяФорма.ОписаниеОтчета     = "Приложение 6 к Положению о представлении декларации об объёмах производства, оборота и использования этилового спирта, алкогольной и спиртосодержащей продукции (Утверждено ПП РФ от 31.12.2005 № 858) (выгрузка в формате 3.02)";
НоваяФорма.ДатаНачалоДействия = '20060101';
...
НоваяФорма.ОписаниеОтчета     = "Приложение 6 к Положению о представлении декларации об объёмах производства, оборота и использования этилового спирта, алкогольной и спиртосодержащей продукции (Утверждено ПП РФ от 31.12.2005 № 858 (в ред. ПП РФ от 26.01.2010 N 26)) (выгрузка в формате 3.02)";
...
НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2009Кв4";
НоваяФорма.ОписаниеОтчета     = "Приложение 6 к Положению о представлении декларации об объёмах производства, оборота и использования этилового спирта, алкогольной и спиртосодержащей продукции (Утверждено ПП РФ от 31.12.2005 № 858 (в ред. ПП РФ от 26.01.2010 N 26)) (выгрузка в формате 3.05)";
...
НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2009Кв4";
НоваяФорма.ОписаниеОтчета     = "Приложение 6 к Положению о представлении декларации об объёмах производства, оборота и использования этилового спирта, алкогольной и спиртосодержащей продукции (Утверждено ПП РФ от 31.12.2005 № 858 (в ред. ПП РФ от 26.01.2010 N 26)) (выгрузка в формате 4.01)";

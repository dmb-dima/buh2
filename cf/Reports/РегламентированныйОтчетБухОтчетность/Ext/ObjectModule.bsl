...
// определим вид конфигурации для управления включением расширенных форм отчетов
ИДКонфигурации = РегламентированнаяОтчетность.ИДКонфигурации();
ВключитьРасширенныеФормыОтчетов = (ИДКонфигурации = "БП" ИЛИ ИДКонфигурации = "БПКОРП"
							  ИЛИ ИДКонфигурации = "БАУ" ИЛИ ИДКонфигурации = "БАУКОРП"
							  ИЛИ ИДКонфигурации = "УПП" ИЛИ ИДКонфигурации = "КА");
...
Если ВключитьРасширенныеФормыОтчетов Тогда
...
НоваяФорма.ДатаКонецДействия  = ?(ВключитьРасширенныеФормыОтчетов, '20110831', ОбщегоНазначения.ПустоеЗначениеТипа(Тип("Дата")));

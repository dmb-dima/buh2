...
Процедура СформироватьОтчет(ДокументРезультат) Экспорт
	...
	Пока ПоПроводкам Или ПоДокументам  Цикл
		...
		Если ДатаЛиста >= ДатаНач Тогда
			...
			НаименованиеОрганизации = СтандартныеОтчеты.ПолучитьТекстОрганизация(, Организация);
			// {ОбособленныеПодразделения
			Если ФормироватьПоПодразделению Тогда
				НаименованиеОрганизации = НаименованиеОрганизации + Символы.ПС + ?(ПустаяСтрока(ПодразделениеОрганизации.НаименованиеПолное), ПодразделениеОрганизации, ПодразделениеОрганизации.НаименованиеПолное);
			КонецЕсли;
			// }ОбособленныеПодразделения 

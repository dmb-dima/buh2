...
Функция ПолучитьСписокПлановОбменаКонфигурацииВерсии30() Экспорт
	...
	Для Каждого ПланОбмена ИЗ Метаданные.ПланыОбмена Цикл
		...
		Попытка
			ВерсияОбменаДанными = МенеджерПланаОбмена.ВерсияОбменаДанными();
		Исключение
			ВерсияОбменаДанными = Неопределено;
		КонецПопытки;
		
		Если ВерсияОбменаДанными = Перечисления.ВерсииПодсистемыОбменаДанными.Версия30 Тогда

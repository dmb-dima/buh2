...
// Выполняет обновление версии правил конвертации/регистрации объектов
...
Процедура ВыполнитьОбновлениеПравилДляОбменаДанными() Экспорт
	...
	ВыполнитьПроверкуНаличияПравилОбменаЗагруженныхИзФайла();
...
Процедура ВыполнитьПроверкуНаличияПравилОбменаЗагруженныхИзФайла()
	...
	Если Не Результат.Пустой() Тогда
		...
		ПланыОбменаМассив = Результат.Выгрузить().ВыгрузитьКолонку("ИмяПланаОбмена");
...
Процедура ВыполнитьОбновлениеВерсииТиповыхПравилДляОбменаДанными(Отказ, ВидПравил)
	...
	Пока Выборка.Следующий() Цикл
		...
		ЗагрузитьПравилаДляОбменаДанными(Отказ, Выборка.ИмяПланаОбмена, ВидПравил, Выборка.ИмяМакетаПравил, Выборка.ИспользоватьФильтрВыборочнойРегистрацииОбъектов);
...
Функция ПолучитьЗначенияСвойствДляСсылки(Ссылка, СвойстваОбъекта, Знач СвойстваОбъектаСтрокой, Знач ОбъектМетаданныхИмя) Экспорт
	...
	ЗначенияСвойств = ОбщегоНазначения.СкопироватьСтруктуру(СвойстваОбъекта);
